...
print ("Welcome to TextPG, the simple text-based RPG that your heart has been craving!")
print ("Based off of the amazing RPGs of yonder year (before Al Gore invented internet)")
print ("© Avinash Kumar 2/19/2017")
print ("\n")
...
class Player(Character):
  ...
  def quit(self):
    ...
    input ()
    self.health = 0
  def help(self): print ("You can type: 'quit', 'help', 'status' 'rest', 'explore', 'flee', or 'attack'")
